      ...
      <div className="main-content">
        ...
        <div className="my-albums-header">
          ...
          <div className="header-actions">
            {activeTab === 'albums' && (
              <Link href="/create-album" className="create-album-link">
                + Create New Album
              </Link>
            )}
            {activeTab === 'songs' && (
              <Link href="/songwriting" className="create-album-link">
                + Create New Song
              </Link>
            )}
          </div>
        ...
        {isLoading ? (
          ...
          albums.length === 0 ? (
            <div className="empty-state">
              ...
              <Link href="/create-album" className="create-link">
          ...
          songs.length === 0 && drafts.length === 0 ? (
            <div className="empty-state">
              ...
              <Link href="/songwriting" className="create-link">
                  ...
                  <div className="albums-grid">
                    {songs.map(song => (
                      <div key={song.id} className="album-card" style={{ position: 'relative' }}>
                        <Link href={`/songwriting/${song.id}`} style={{ textDecoration: 'none', color: 'inherit' }}>
                          <div className="album-cover">
                  ...
                  <div className="albums-grid">
                    {drafts.map((draft, idx) => (
                      <div key={`draft-${idx}`} className="album-card" style={{ position: 'relative', border: '2px solid #ffa500' }}>
                        <Link href="/songwriting" style={{ textDecoration: 'none', color: 'inherit' }}>
                          <div className="album-cover">
