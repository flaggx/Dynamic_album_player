        ...
        <div className="content-area">
          <div className="greeting-section">
            ...
            <div className="quick-access-grid">
              <Link href="/discover" className="quick-access-card">
                <div className="card-icon search-icon"></div>
                <span>Search</span>
              </Link>
              <Link href="/create-album" className="quick-access-card">
                <div className="card-icon plus-icon"></div>
                <span>Create Album</span>
              </Link>
              <Link href="/my-albums" className="quick-access-card">
                <div className="card-icon library-icon"></div>
                <span>Your Library</span>
              </Link>
              <Link href="/my-favorites" className="quick-access-card">
            ...
            <>
              <div className="section">
                <div className="section-header">
                  <h2>Trending Now</h2>
                  <Link href="/discover" className="see-all-link">Show all</Link>
                </div>
                {trendingAlbums.length > 0 ? (
                  <div className="cards-grid">
                    {trendingAlbums.map(album => (
                      <Link key={album.id} href={`/album/${album.id}`} className="feature-card">
                  ...
                  <div className="empty-state" style={{ padding: '2rem', textAlign: 'center', color: 'var(--spotify-light-gray)' }}>
                    ...
                    <Link href="/create-album" className="see-all-link" style={{ marginTop: '1rem', display: 'inline-block' }}>
                      Create Album
                    </Link>
                  </div>
                )}
              ...
              <div className="section">
                ...
                <div className="cards-grid">
                  ...
                  <Link href="/create-album" className="feature-card">
                    <div className="feature-card-image">
